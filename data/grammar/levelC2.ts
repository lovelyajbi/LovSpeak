...
export const LEVEL_C2: GrammarLesson[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        examples: [
          { text: 'God save the King.', isCorrect: true },
          { text: 'Suffice it to say, we are disappointed.', isCorrect: true },
          { text: 'Be that as it may, we must continue.', isCorrect: true },
          { text: 'Heaven forbid that such a thing happen.', isCorrect: true },
          { text: 'So be it then.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'It is vital that he not be late.', isCorrect: true },
          { text: 'I suggest that they not participate.', isCorrect: true },
          { text: 'It is imperative that we not forget our values.', isCorrect: true },
          { text: 'She recommended that the child not see the film.', isCorrect: true },
          { text: 'He insisted that the news not be leaked.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'It is imperative that justice be served for all.', isCorrect: true },
          { text: 'I suggest that we all work together for peace.', isCorrect: true },
          { text: 'It is essential that every member follow the code.', isCorrect: true },
          { text: 'I recommend that the council rethink the decision.', isCorrect: true },
          { text: 'It is vital that the truth be revealed slowly.', isCorrect: true }
        ]
      }
    ],
    mindmap: {
    ...
    sections: [
      {
        ...
        examples: [
          { text: 'Never have I witnessed such profound wisdom.', isCorrect: true },
          { text: 'Under no circumstances should you open that door.', isCorrect: true },
          { text: 'Rarely does one encounter such integrity.', isCorrect: true },
          { text: 'Little did they realize the impact of their words.', isCorrect: true },
          { text: 'Not only was he a scholar, but he was also a leader.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'Had I known, I would have acted differently.', isCorrect: true },
          { text: 'Should you require further assistance, do let us know.', isCorrect: true },
          { text: 'Were he to apologize, I might forgive him.', isCorrect: true },
          { text: 'Had the rain not stopped, the event would be canceled.', isCorrect: true },
          { text: 'Should there be any issues, please call me.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'Only then did I understand the gravity of the situation.', isCorrect: true },
          { text: 'Not until I arrived home did I realize I lost my bag.', isCorrect: true },
          { text: 'Only after the meeting was over were we allowed to speak.', isCorrect: true },
          { text: 'Only in this way can we achieve true success.', isCorrect: true },
          { text: 'Not until next year will we see the results.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'Beside the river grew beautiful white lilies.', isCorrect: true },
          { text: 'Hidden in the archives were the forgotten letters.', isCorrect: true },
          { text: 'Standing in the corner was a mysterious man.', isCorrect: true },
          { text: 'From the minaret came the beautiful sound of Adzan.', isCorrect: true },
          { text: 'On the wall hung a large map of the world.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'In no way can this be considered a failure.', isCorrect: true },
          { text: 'Only through patience will we find peace.', isCorrect: true },
          { text: 'Seldom have we seen such dedication to knowledge.', isCorrect: true },
          { text: 'Never before has the world needed more compassion.', isCorrect: true },
    ...
    sections: [
      {
        ...
        examples: [
          { text: 'It was his honesty that impressed everyone.', isCorrect: true },
          { text: 'It is the Quran that provides the ultimate guidance.', isCorrect: true },
          { text: 'It was in Medina that the first Muslim community grew.', isCorrect: true },
          { text: 'It is through science that we understand the universe.', isCorrect: true },
          { text: 'It was last night that the decision was finalized.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'What he said was very inspiring to us.', isCorrect: true },
          { text: 'What I admire most about him is his patience.', isCorrect: true },
          { text: 'What happened was a total misunderstanding.', isCorrect: true },
          { text: 'What we seek is Allah\'s pleasure.', isCorrect: true },
          { text: 'What she loves is learning new things.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'Sincerity is what makes a deed valuable.', isCorrect: true },
          { text: 'A sincere smile is what she gave me.', isCorrect: true },
          { text: 'Knowledge is what sets us free.', isCorrect: true },
          { text: 'Peace is what every soul yearns for.', isCorrect: true },
          { text: 'This book is what I have been looking for.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'All he did was offer a helping hand.', isCorrect: true },
          { text: 'All I ask for is a bit of honesty.', isCorrect: true },
          { text: 'All that matters is your intention.', isCorrect: true },
          { text: 'All she wanted was to serve her parents.', isCorrect: true },
          { text: 'All we can do is try our best.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'It is the Quran that illuminates our hearts.', isCorrect: true },
          { text: 'What defines a person is their character.', isCorrect: true },
          { text: 'It was the Sahabah who spread the light of faith.', isCorrect: true },
          { text: 'All we seek is a meaningful life under His guidance.', isCorrect: true },
          { text: 'Patience is what helps us endure the darkest nights.', isCorrect: true }
        ]
      }
    ],
    mindmap: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Filosofi Densitas: Dari Narasi ke Abstraksi',
        ...
        examples: [
          { text: 'The implementation of the new law was successful.', isCorrect: true },
          { text: 'Rapid urbanization poses many challenges.', isCorrect: true },
          { text: 'Her persistence led to great discoveries.', isCorrect: true },
          { text: 'The analysis of the data confirmed the theory.', isCorrect: true },
          { text: 'Failure to comply will result in a penalty.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'The distribution of wealth is a global issue.', isCorrect: true },
          { text: 'Technological advancement changed our lives.', isCorrect: true },
          { text: 'His rejection of the offer was unexpected.', isCorrect: true },
          { text: 'Scientific discovery requires immense patience.', isCorrect: true },
      ...
      },
      {
        ...
        examples: [
          { text: 'The sudden disappearance of the evidence shocked everyone.', isCorrect: true },
          { text: 'Careful preparation is the key to a good presentation.', isCorrect: true },
          { text: 'Environmental protection is a shared responsibility.', isCorrect: true },
          { text: 'Fluctuations in market prices affect local farmers.', isCorrect: true },
          { text: 'The restoration of the mosque took five years.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'Our dependence on technology is growing.', isCorrect: true },
          { text: 'She has a deep commitment to education.', isCorrect: true },
          { text: 'Resistance to change is a natural human trait.', isCorrect: true },
          { text: 'His preference for classic literature is well-known.', isCorrect: true },
          { text: 'The frequency of his visits increased.', isCorrect: true }
        ]
      },
      {
        heading: '5. Konteks Hikmah: Bahasa Prinsip yang Mulia',
        content: 'Dalam Islam, penggunaan kata benda abstrak (Mashdar) untuk menjelaskan konsep iman sangatlah umum (*Ikhlas, Sabr, Tawakkal*). Nominalisasi membantu kita mentransformasikan aksi ibadah menjadi prinsip hidup yang kokoh dalam bahasa Inggris.\n\nAlih-alih hanya berkata "We should be patient," menggunakan nominalisasi "The practice of patience" memberikan kedalaman filosofis bahwa kesabaran adalah sebuah sistem atau disiplin ilmu. Gunakanlah nominalisasi untuk mengangkat topik-topik spiritual ke level diskusi intelektual yang lebih bermartabat.',
        examples: [
          { text: 'The pursuit of knowledge is an obligation.', isCorrect: true },
          { text: 'The development of character starts from within.', isCorrect: true },
          { text: 'Sincerity of heart is the essence of every deed.', isCorrect: true },
          { text: 'The spread of peace is our primary objective.', isCorrect: true },
          { text: 'Gratitude for blessings increases our abundance.', isCorrect: true }
        ]
      }
    ],
    mindmap: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Filosofi Korelasi: Hubungan Simbiotis',
        ...
        examples: [
          { text: 'The more you learn, the more you realize how little you know.', isCorrect: true },
          { text: 'The harder you work, the luckier you become.', isCorrect: true },
          { text: 'The faster we finish, the earlier we can go home.', isCorrect: true },
          { text: 'The more generous she is, the happier she feels.', isCorrect: true },
          { text: 'The higher the pressure, the better the result.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'The sooner, the better.', isCorrect: true },
          { text: 'The bigger, the better.', isCorrect: true },
          { text: 'The more, the merrier.', isCorrect: true },
          { text: 'The less said, the better.', isCorrect: true },
          { text: 'The cheaper, the worse.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'The more he earns, the less he saves.', isCorrect: true },
          { text: 'The more she practices, the fewer mistakes she makes.', isCorrect: true },
          { text: 'The more complex the problem, the simpler the solution should be.', isCorrect: true },
          { text: 'The more we wait, the lower our chances become.', isCorrect: true },
          { text: 'The less you care, the more peaceful you are.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'The more fluently you speak, the more confident you sound.', isCorrect: true },
          { text: 'The more deeply we think, the more wisdom we find.', isCorrect: true },
          { text: 'The more carefully you drive, the safer you are.', isCorrect: true },
          { text: 'The more sincerely you pray, the calmer you feel.', isCorrect: true },
          { text: 'The more efficiently we work, the more time we save.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'The more we give in charity, the more our wealth is blessed.', isCorrect: true },
          { text: 'The more we remember Allah, the more our hearts find rest.', isCorrect: true },
          { text: 'The more patient we are, the greater our reward will be.', isCorrect: true },
          { text: 'The more we seek knowledge, the closer we get to the truth.', isCorrect: true },
          { text: 'The more humble a person is, the higher they are raised by Allah.', isCorrect: true }
        ]
      }
    ],
    mindmap: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Filosofi Brevitas: Menghapus yang Redundan',
        ...
        examples: [
          { text: 'Ahmad has been to Mecca, and so has Ali.', isCorrect: true },
          { text: 'I don\'t want to go, but I have to (go).', isCorrect: true },
          { text: 'She can speak English, but her brother can\'t (speak English).', isCorrect: true },
          { text: 'If (it is) necessary, we will call you.', isCorrect: true },
      ...
      },
      {
        ...
        examples: [
          { text: 'They believe the project will succeed, and I do too.', isCorrect: true },
          { text: 'Will it rain? I suspect so.', isCorrect: true },
          { text: 'Do you want to join? If so, let me know.', isCorrect: true },
          { text: 'He might be late, but I hope not.', isCorrect: true },
          { text: 'She speaks Arabic well, and so does her teacher.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'My father likes books; my mother, flowers.', isCorrect: true },
          { text: 'Cairo is the capital of Egypt; Jakarta, of Indonesia.', isCorrect: true },
          { text: 'One team wore blue shirts; the other, red.', isCorrect: true },
          { text: 'He gave me a book; she, a pen.', isCorrect: true },
          { text: 'The first lesson was easy; the second, hard.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'He is leaving, but he didn\'t say when.', isCorrect: true },
          { text: 'They are hiding something, but I don\'t know what.', isCorrect: true },
          { text: 'Someone is singing outside; can you see who?', isCorrect: true },
          { text: 'We need to fix this, but we aren\'t sure how.', isCorrect: true },
          { text: 'She visited a city, but I forgot which.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'He promised to help, and he did.', isCorrect: true },
          { text: 'Allah loves those who do good, and we should too.', isCorrect: true },
          { text: 'Recite what is easy for you (to recite).', isCorrect: true },
          { text: 'If you can help, do (help).', isCorrect: true },
          { text: 'Some seek fame; the wise, knowledge.', isCorrect: true }
        ]
      }
    ],
    mindmap: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Filosofi Jarak: Objektivitas Tanpa "Saya"',
        ...
        examples: [
          { text: 'It is expected that the economy will grow.', isCorrect: true },
          { text: 'He is believed to have discovered a new planet.', isCorrect: true },
          { text: 'It is known that patience leads to success.', isCorrect: true },
          { text: 'She is considered to be the best student.', isCorrect: true },
          { text: 'It is reported that the mission was a success.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'He is thought to be living in Cairo now.', isCorrect: true, note: 'Continuous status.' },
          { text: 'They are believed to have finished the work.', isCorrect: true, note: 'Past result.' },
          { text: 'The city is said to be very ancient.', isCorrect: true },
          { text: 'The documents are reported to have been stolen.', isCorrect: true, note: 'Passive infinitive.' },
          { text: 'She is rumored to be writing a new book.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'He is alleged to have committed the crime.', isCorrect: true },
          { text: 'The damage is estimated to be millions of dollars.', isCorrect: true },
          { text: 'She is acknowledged to be a pioneer in her field.', isCorrect: true },
          { text: 'The plan is presumed to be safe.', isCorrect: true },
          { text: 'It is claimed that the remedy works instantly.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'It is being suggested that we postpone the event.', isCorrect: true },
          { text: 'It had been believed that the earth was flat.', isCorrect: true },
          { text: 'It has been acknowledged that mistakes were made.', isCorrect: true },
          { text: 'It is being claimed that a solution has been found.', isCorrect: true },
          { text: 'It was once thought that gravity worked differently.', isCorrect: true }
        ]
      },
      {
        ...
        examples: [
          { text: 'It is reported that the crescent moon has been sighted.', isCorrect: true },
          { text: 'He is considered to be a very pious person.', isCorrect: true },
          { text: 'The message is believed to have reached everyone.', isCorrect: true },
          { text: 'It is understood that we must wait for verification.', isCorrect: true },
          { text: 'They are thought to be working for the common good.', isCorrect: true }
        ]
      }
    ],
    mindmap: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Filosofi Akumulasi: Menghargai Investasi Waktu',
        ...
        examples: [
          { text: 'By 2030, I will have been working here for twenty years.', isCorrect: true },
          { text: 'Next June, she will have been living in Cairo for a decade.', isCorrect: true },
          { text: 'In two hours, we will have been driving for 500 miles.', isCorrect: true },
          { text: 'By Ramadan, they will have been fasting for 10 years.', isCorrect: true },
          { text: 'How long will you have been traveling by the time you reach Mecca?', isCorrect: true }
        ]
      },
      {
      ...
      },
      {
        ...
        examples: [
          { text: 'By next year, I will have known Ali for five years.', isCorrect: true },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        examples: [
          { text: 'A ten-minute break.', isCorrect: true },
          { text: 'A six-year-old child.', isCorrect: true },
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Filosofi Navigasi: Peta Pikiran Intelektual',
