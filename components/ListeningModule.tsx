  ...
  const renderSetup = () => (
    <div className="max-w-4xl mx-auto px-2 md:px-0">
      ...
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-4 md:p-6 rounded-2xl md:rounded-3xl shadow-sm border border-lovelya-100 dark:border-gray-700 animate-fade-in">
        <h2 className="text-base md:text-xl font-black mb-3 md:mb-4 text-lovelya-700 dark:text-lovelya-300 text-center tracking-tight">
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {currentTitles.map((title, idx) => (
                <button key={idx} onClick={() => handleSelectTitle(title)} className="bg-white dark:bg-gray-800 p-4 md:p-5 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-lovelya-400 hover:shadow-lg transition-all text-left h-full flex flex-col justify-between group transform hover:-translate-y-1">
              ...
              <button 
                ...
                className="bg-gray-50 dark:bg-gray-800/50 p-4 md:p-5 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-600 hover:border-lovelya-400 hover:bg-lovelya-50 dark:hover:bg-lovelya-900/20 transition flex flex-col items-center justify-center gap-2 md:gap-3 group min-h-[90px] md:min-h-[120px]"
              >
