...
const LivePracticeModule: React.FC<ModuleProps> = ({ initialContext, onComplete }) => {
  ...
  const startSession = async () => {
    ...
    try {
      ...
      7. SALAM ETIQUETTE: If the user says "Assalamualaikum" at any point, you MUST respond with "Waalaikumussalam" (properly following Islamic etiquette) before continuing with the rest of your response. This is mandatory even if you already greeted them.`;
