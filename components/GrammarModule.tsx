      ...
      <div className="max-w-4xl mx-auto animate-fade-in space-y-4 pb-20">
        ...
        {activeTab === 'explanation' && (
          <div className="space-y-4 md:space-y-6 animate-slide-up">
            <div className="bg-gradient-to-r from-lovelya-600 to-indigo-600 p-4 md:p-6 rounded-3xl text-white shadow-lg relative overflow-hidden">
                ...
                <h1 className="text-base md:text-xl font-black mb-0.5 leading-tight">{selectedLesson.title}</h1>
            ...
            <div className="grid grid-cols-1 gap-4">
               {selectedLesson.sections.map((section, idx) => (
                 <div key={idx} className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
